...
<script>
    ...
    export default{
        ...
        computed: {
            ...mapState(['user']),
            bgList() {
                return [{name: '远方', url: '/img/wallpaper.jpg', id: 1}, {name: '昨日青空', url: '/img/0055.jpg', id: 2}, {name: '希望', url: '/img/xiang.jpg', id: 3}, {name: '自定义', url: this.user.wallpaper.split(',')[1] || '', id: 4}];
            }
        },
        methods: {
            upUserInfo(params) {
